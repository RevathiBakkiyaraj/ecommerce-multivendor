...
import com.rev.domain.AccountStatus;
...
import com.rev.service.SellerReportService;
...
public class SellerController {
    ...
    public ResponseEntity<Seller> createSeller
        ...
        String subject = "Rev Bazaar Email Verification Code";
        String text = "Welcome to Rev Bazaar, verify your account using this link";
